...
public class Protocol {
	...
	public static final byte TRANSMITION_RESPONSE_TYPE = 11;//��¼����ļ����յĻ�Ӧ
	public static final byte FILE_TYPE = 12;//���Կͻ��˵��ļ���������
	public static final byte FILE_TRANS_TYPE = 13;//��ʱû��
	public static final byte FILE_RESPONSE_TYPE = 14;//���ߴ����Ӧ
	public static final byte GROUP_CREATE_TYPE = 15;
	public static final byte GROUP_JOIN_TYPE = 16;
	public static final byte GROUP_RESPONSE_TYPE = 17;
	public static final byte FRIEND_RESPONSE_TYPE = 18;
}
